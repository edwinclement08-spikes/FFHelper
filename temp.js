...
function allChapterDoneEDWIN(){
    ...
    console.log("SCROLL SAVE SYSTEM ACTIVE");
...
#bookmarksDiv {position:fixed; background:lightgrey; border: grey thin solid; top:20%; left:1%;  min-height: 10%; min-width: 10%; user-select:none !important;}
...
<span class="hvr-temp" onclick="bookmarkItemDelete(event);">x</span>
                ...
                db.fics[ficId].bookmarks = [["latest", db.fics[ficId].scrollPoint]];
                localStorage.setItem("FFSaveLocation", JSON.stringify(db));
